...
const matrix_apply_rows = (matrix, fun) => create_matrix_by_rows(rows(matrix), (i) => fun(matrix_row(i)))

const matrix_apply_columns = (matrix, fun) => create_matrix_by_columns(columns(matrix), (j) => fun(matrix_column(j)))
